# Based on deep learning YOLOv8, the construction site transport vehicle recognition detection system (YOLOv

## Body

Based on the deep learning YOLOv8, a construction vehicle detection system (YOLOv)
